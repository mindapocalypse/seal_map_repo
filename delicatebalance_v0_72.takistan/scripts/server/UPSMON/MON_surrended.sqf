...

{
	if ( leader _x == _x ) then {
		_x addaction ["Order your men to follow me", "scripts\server\UPSMON\actions\followme.sqf", [], 1, false];
	} else {
		_x addaction ["Follow me", "scripts\server\UPSMON\actions\followme.sqf", [], 1, false];
	};
}foreach _soldiers;
