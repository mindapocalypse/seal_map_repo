...
script_handler = ["helistop", (getDir _position), objposition] execVM "scripts\server\objectMapper.sqf";
waitUntil {scriptDone script_handler};
			
missionobject = createVehicle ["BAF_Merlin_HC3_D", objposition , [], 0, "NONE"];
sleep 0.1;
