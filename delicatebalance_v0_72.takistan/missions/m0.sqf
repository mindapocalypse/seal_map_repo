...
script_handler = ["fuelbase", (getDir _position), objposition] execVM "scripts\server\objectMapper.sqf";
waitUntil {scriptDone script_handler};
			
missionobject = createVehicle ["Land_Ind_TankSmall", objposition , [], 0, "NONE"];
sleep 0.1;
