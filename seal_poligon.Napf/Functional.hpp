class Functional
{
	...
	objects[]={};
	controls[]={setHaloMarker, selfTeleport, groupTeleport, emptyVehicle, createEnemy, deleteEnemy, setTime, setFog, setRain, setHalo, createArty, closeMenu, unitTeleportCombo, vehicleNameCombo, enemyCreateCombo, setTimeCombo, setFogCombo, setRainCombo, setHaloCombo};
