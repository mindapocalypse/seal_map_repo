...
switch _loadout do {
	...
	case "RPG" : { //
		_veh addWeaponCargo ["ACE_RPG22",60];
		_veh addWeaponCargo ["RPG18",60];
	};
	case "TANK" : { //
	...
	case "MED" : { //
		_veh addMagazineCargo ["ACE_Bandage",100];
		_veh addMagazineCargo ["ACE_Morphine",100];
		_veh addMagazineCargo ["ACE_Epinephrine",100];
		_veh addMagazineCargo ["ACE_LargeBandage",100];
		_veh addMagazineCargo ["ACE_Tourniquet",100];
		_veh addMagazineCargo ["ACE_Splint",100];
		_veh addMagazineCargo ["ACE_IV",20];
		_veh addMagazineCargo ["ACE_Plasma",20];
		_veh addMagazineCargo ["ACE_Medkit",100];
