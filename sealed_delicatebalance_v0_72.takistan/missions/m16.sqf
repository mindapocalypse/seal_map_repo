...
script_handler = ["roadpost", (getDir _position), objposition] execVM "scripts\server\objectMapper.sqf";
waitUntil {scriptDone script_handler};
			
missionobject = createVehicle ["MAZ_543_SCUD_TK_EP1", objposition , [], 0, "NONE"];
sleep 0.1;
