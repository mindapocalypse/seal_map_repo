...
//    nul=[this,"area0"] execVM "scripts\server\upsmon.sqf";
//
//  Defensive squad samples:
//    nul=[this,"area0","nomove"] execVM "scripts\server\upsmon.sqf";
//
//  Reinforcement
//    nul=[this,"area0","reinforcement:",1] execVM "scripts\server\UPSMON.sqf";
...
// TBD: add to global side arrays?
	...
	// create the clones
		for "_grpcnt" from 1 to _copies do {
			...
			nul=[_lead,_areamarker,_pause,_noslow,_nomove,_nofollow,_initpos,_track,_showmarker,_shareinfo,"DELETE:",_dead] execVM "scripts\server\upsmon.sqf";
			//sleep .05;
		};	
		processInitCommands;
		sleep .05;
